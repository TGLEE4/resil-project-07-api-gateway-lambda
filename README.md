...
Destroy only the Project 7 API Gateway resources after testing to avoid unnecessary resources staying active
Tools & Environment
Tool	Version / Setup
...
Create a new Lambda function inside Project 7, or
